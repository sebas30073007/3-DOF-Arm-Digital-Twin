...
const float LIM_MIN[3]   = { -80.0f,   0.0f, -220.0f };
const float LIM_MAX[3]   = {  80.0f, 136.5f,    0.0f };
...
const C=[{n:'Base',k:'b',h:null,inv:0},{n:'Eslabón 1',k:'c',h:0,inv:0},{n:'Eslabón 2',k:'m',h:0,inv:1}];
const RED=[10,25,25];
